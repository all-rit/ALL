...
const RepairService = {
  submitRepairButton: (height, width) => {
    return API.postWithBody(
      import.meta.env.VITE_REACT_APP_SERVER_URL +
        endpoints.SUBMIT_REPAIR_BUTTON,
      {
        height,
        width,
      },
  ...
  submitRepairSkip: (skiptomain) => {
    return API.postWithBody(
      import.meta.env.VITE_REACT_APP_SERVER_URL + endpoints.SUBMIT_REPAIR_SKIP,
      {
        skiptomain,
      },
    );
  ...
  submitRepairHint: (tabindex) => {
    return API.postWithBody(
      import.meta.env.VITE_REACT_APP_SERVER_URL + endpoints.SUBMIT_REPAIR_HINT,
      {
        tabindex,
      },
    );
