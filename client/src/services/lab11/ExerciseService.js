...
const ExerciseService = {
  ...
  submitExercise: async (data) => {
    try {
      const body = {
        userID: data.userid,
        isRepairWordCountComplete: data.isRepairWordCountComplete,
        isRepairSentenceCountComplete: data.isRepairSentenceCountComplete,
        isRepairComplexWordCountComplete: data.isRepairComplexWordCountComplete,
      };
