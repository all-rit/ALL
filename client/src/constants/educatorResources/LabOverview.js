...
export const LabOverview = [
  ...
  },
  {
    ...
    description:
      "The Exercise section is the heart of the lab, offering a hands-on interactive scenario where participants confront accessibility challenges or poorly trained AI/ML models. Participants are tasked with 'repairing' these components using JavaScript in our custom code editor. Once corrected, they can reattempt the task using the repaired component, gaining both practical skills and a deeper understanding of the topic.",
    image: Placeholder,
  },
  {
    id: 4,
