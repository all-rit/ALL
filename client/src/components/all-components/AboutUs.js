        ...
        <div className="tw-h-full tw-flex tw-flex-row tw-justify-center tw-border-t-[.75rem] tw-border-r-[.75rem] tw-rounded-tr-lg tw-border-b-0 tw-border-l-0 tw-border-solid tw-border-primary-blue tw-bg-white">
          <div className="tw-flex tw-flex-col lg:tw-flex-row tw-text-left tw-w-full sm:tw-w-1/2 tw-p-5 tw-min-h-[15rem]">
            <div className="tw-flex tw-flex-col xs:tw-w-full lg:tw-w-3/4 tw-h-full tw-justify-center">
              <h1 className="tw-title-styling-name tw-my-6 tw-font-poppins tw-leading-3 tw-text-center lg:tw-text-left">
                About Us
              </h1>
              <p className="tw-body-styling-name tw-text-center sm:tw-text-left">
                Learn more about the team at Accessible Learning Labs and the
                amazing things we have in the works!
              </p>
            </div>
            <div className="tw-h-full lg:tw-w-4/5 tw-w-full tw-flex tw-flex-col tw-justify-end sm:tw-items-end tw-items-center tw-py-5 ">
              <ALLButton label={"Learn More"} onClick={handleNav}></ALLButton>
            </div>
          </div>
        </div>
      </div>
      <div className="tw-w-full tw-h-1/2 tw-hidden xl:tw-block">
        <div
          ref={yellowBlock}
          className={
