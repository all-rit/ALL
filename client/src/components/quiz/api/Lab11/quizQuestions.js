...
const quizQuestionsLab11 = [
    ...
    {
      question:
        "What are the primary considerations to creating readable web content?",
      answers: [
        {
          val: 1,
          type: "0",
        ...
        },
        {
          ...
          type: "1",
          content:
            "Font size, font color, and text alignment",
        },
        {
          val: 0,
          type: "2",
          content:
            "Navigation and color schemes",
        },
        {
          val: 0,
          type: "3",
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          type: "2",
          content:
            "Use concise and brief text content",
        },
        {
          val: 1,
          type: "3",
    ...
    {
      question:
        "What is the recommended education level for targeting a broad consumer audience?",
      answers: [
        {
          val: 0,
          type: "0",
  ...
  export default quizQuestionsLab11;
