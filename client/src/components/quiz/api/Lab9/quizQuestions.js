...
const quizQuestionsLab9 = [
    ...
    {
      question:
        "Which of the following are elements to consider when localizing a software application?",
      answers: [
        {
          val: 1,
          type: "0",
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          type: "2",
          content:
            "For accurate data interpretation and financial transactions",
        },
        {
          val: 0,
          type: "3",
    ...
    {
      question:
        "Which of the following is NOT a common challenge in localization?",
      answers: [
        {
          val: 0,
          type: "0",
    ...
    {
      question:
        "Which of the following is the primary responsibility of a software engineer in the process of localization?",
      answers: [
        {
          val: 1,
          type: "0",
          content:
            "Ensuring the software architecture supports localization.",
        },
        {
          val: 0,
          type: "1",
          content:
            "Translating the content into various languages.",
        },
        {
          val: 0,
          type: "2",
          content:
            "Designing marketing strategies for different regions.",
        },
        {
          val: 0,
          type: "3",
          content:
            "Conducting cultural research for each target market.",
        },
      ],
      multiChoice: false,
    },
  ...
  export default quizQuestionsLab9;