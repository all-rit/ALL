...
class NotificationInaccessibleKnowledgeCheck extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {selected: false, componentName:"NotificationInaccessibleKnowledgeCheck" };
    }
    ...
    render() {
        ...
        return (
            <div>
                <KnowledgeTest handler={this.handler} question = {KnowledgeCheck} link={"/Lab5/Exercise/NotificationGuidance"}/>
