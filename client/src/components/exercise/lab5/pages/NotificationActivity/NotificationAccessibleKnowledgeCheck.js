...
class NotificationAccessibleKnowledgeCheck extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {selected: false, componentName: "NotificationAccessibleKnowledgeCheck"};
    }
    ...
    render() {
        ...
        return (
            <div>
                <KnowledgeTest handler={this.handler} question = {KnowledgeCheck} link={"/Lab5/Exercise/NotificationInaccessible"}/>
