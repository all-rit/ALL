...
const AIChatBot = ({ userQuestions, fixedAIResponse, onAnswerDataChange, onTypingChange, onThinkingChange }) => {
    ...
    // Close dropdown and reset answer data when questions change (moving to next topic)
        ...
        >
            ...
            >
                ...
                {messages.map((msg, index) => (
                    ...
                    >
                        <div
                            className={`tw-text-black tw-text-left tw-p-3 tw-rounded-lg tw-break-words ${msg.sender === 'bot'
            ...
            <div className="tw-relative tw-w-full tw-flex tw-justify-center tw-z-20">
                ...
                <div
                    className={`tw-absolute tw-pointer-events-none tw-transition-all tw-duration-300 ${isOpen ? 'tw-opacity-100' : 'tw-opacity-0'
                        }`}
                    style={{
                        width: 0,
                        height: 0,
                ...
                <div
                    ref={dropdownRef}
                    className={`tw-absolute tw-bottom-[48px] tw-w-[95%] tw-bg-white tw-shadow-lg tw-transition-all tw-duration-300 tw-border-2 tw-overflow-y-auto tw-border-black tw-rounded-lg tw-z-20 tw-ease-[cubic-bezier(0.4,0,0.2,1)] ${isOpen
