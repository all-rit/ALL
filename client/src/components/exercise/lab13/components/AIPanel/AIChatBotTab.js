import { BIAS_DEFINITIONS, BIAS_POSITION_MAP, BIAS_TYPES } from 'src/constants/lab13/BiasQuestionsConfig';
...
const AIChatBotTab = ({
    ...
    const handleAnswerSelected = (biasType, biasDefinition, explanation, aiResponseText) => {
        setSelectedBiasData({
            biasType,
            biasDefinition,
            explanation,
