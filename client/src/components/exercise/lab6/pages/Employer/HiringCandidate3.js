...
const HiringCandidate3 = (props) => {
    ...
    const handleContinue = () => {
        navigate("/Lab6/Exercise/HiringCandidate4");
    }
    ...
    return (
        <Form>
            ...
            <div className="center-div">
                <h2 className="playthrough__title" >Choose your third Candidate!</h2>
...
export default HiringCandidate3;
