  ...
  return (
    <div className="center-div">
      ...
      <Form onSubmit={onFormSubmit}>
        <div className="center-div">
          <h2 className="cognitive_instructions">What is your age?</h2>
          ...
          <div className="analysis__questions">
            <FormGroup check>
              <Label for="age" check>
                ...
                />
                <div className="analysis__question">Less than 18</div>
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label for="age" check>
                <Input
                  ...
                  className="analysis__checkbox"
                />
                <div className="analysis__question">18-25</div>
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label for="age" check>
                <Input
                  ...
                  className="analysis__checkbox"
                />
                <div className="analysis__question">25-45</div>
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label for="age" check>
                <Input
                  ...
                  className="analysis__checkbox"
                />
                <div className="analysis__question">45-65</div>
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label for="age" check>
                <Input
                  ...
                  className="analysis__checkbox"
                />
                <div className="analysis__question">65+</div>
              </Label>
            </FormGroup>
          </div>
