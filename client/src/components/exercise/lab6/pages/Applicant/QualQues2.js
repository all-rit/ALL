          ...
          <div className="analysis__questions">
            <FormGroup check>
              <Label for="years" check>
                ...
                />
                <div className="analysis__question">0</div>
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label for="years" check>
                <Input
                  ...
                  className="analysis__checkbox"
                />
                <div className="analysis__question">1-4</div>
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label for="years" check>
                <Input
                  ...
                  className="analysis__checkbox"
                />
                <div className="analysis__question">5-10</div>
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label for="years" check>
                <Input
                  ...
                  className="analysis__checkbox"
                />
                <div className="analysis__question">10+</div>
              </Label>
            </FormGroup>
          </div>
