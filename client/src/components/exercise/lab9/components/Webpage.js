          ...
          <div className="tw-self-center tw-flex tw-ml-0 tw-w-full tw-max-w-[1373px] tw-items-start tw-justify-between tw-gap-5 tw-mt-px tw-mb-px tw-max-md:tw-max-w-full tw-max-md:tw-flex-wrap">
            ...
            <div className="tw-self-center tw-flex tw-items-start tw-justify-between tw-gap-2 tw-my-auto tw-max-md:tw-max-w-full tw-max-md:tw-flex-wrap tw-max-md:tw-justify-center">
              ...
              <img
                loading="lazy"
                srcSet="..."
                className="tw-aspect-[2] tw-object-cover tw-object-center tw-w-3.5 tw-shrink-0 mt-1"
              />
                ...
                <div className="tw-shadow-[3px_4px_7px_0px_rgba(0,0,0,0.25)] tw-bg-[#D9D9D9] tw-flex tw-grow tw-flex-col tw-w-full tw-mx-auto tw-px-5 tw-py-5 tw-max-md:tw-max-w-full tw-max-md:tw-mt-12">
                  <div className="tw-self-stretch tw-flex tw-mb-0 tw-flex-col tw-ml-0.5 tw-mr-4 tw-mt-0.5 tw-max-md:tw-max-w-full tw-max-md:mr-2.5">
                    ...
                    <div className="tw-self-center tw-flex tw-ml-0 tw-max-w-full tw-items-start tw-justify-between tw-gap-5 tw-mt-7 tw-max-md:flex-wrap">
                      <div className="tw-flex tw-grow tw-shrink-0 tw-basis-auto tw-items-start tw-justify-between tw-gap-3.5 tw-max-md:max-w-full tw-max-md:tw-flex-wrap tw-max-md:tw-justify-center">
                        ...
                        <img
                          loading="lazy"
                          srcSet="..."
                          className="tw-aspect-[5.23] tw-object-cover tw-object-center tw-w-[162px] tw-shrink-0 tw-border-[3px] tw-border-solid tw-border-black"
                        />
                      </div>
                    ...
                    <div className="tw-flex w-[813px] tw-max-w-full tw-items-start tw-justify-between tw-gap-3 tw-mr-1 tw-mt-7 tw-max-md:tw-flex-wrap tw-max-md:tw-justify-center">
                      ...
                      <div className="tw-flex tw-w-[141px] tw-h-[31px] tw-flex-col tw-border-[3px] tw-border-solid tw-border-black" />
                      <div className="tw-shadow-[0px_4px_7px_0px_rgba(0,0,0,0.25)] tw-self-stretch tw-flex tw-w-[137px] tw-max-w-full tw-flex-col tw-px-5 tw-py-2.5 border-[3px] border-solid border-stone-900">
                        <div className="tw-justify-center tw-text-[#260D0D] tw-text-center tw-text-base tw-self-center tw-mb-0 w-[147px] mt-0.5">
                          Sign Up
                        </div>
                      </div>
                    </div>
