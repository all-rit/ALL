...
const DateformRepair = () => {
	const [dateForms] = useState(DateFormData.countries);
	return (
		<>
		<ReactText>const DateForm = (props) =&#62; &#123;</ReactText>
			...
			{dateForms.map((country, index) => (
				...
				<CodeLine>
					<Tab /> <ReactText> const {country.countryVariable} = &ldquo;{country.countryName}&rdquo; </ReactText>
				</CodeLine>
			))}
		...
		<CodeLine>
			...
			{dateForms.map((country, index) => (
				<>
					<CodeLine>
						<MultiTab numberOfTabs={2}/><ReactText> &ldquo;{country.countryVariable}&rdquo; = &#123;</ReactText>
					</CodeLine>
					<CodeLine>
