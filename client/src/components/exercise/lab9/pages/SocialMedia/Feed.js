      ...
      <div className="main-div">
        <div className="content-div">
          <span className="user-post">
            <div className="post-text guidance tw-font-bold">
              <img className={"poster-image"} alt="posting-user" src={user828}/>
              <p className="tw-font-bold ">User828 Posted: This cat is the cutest!</p>
            </div>
          </span>
          <span className={"reply tw-ml-3 tw-mt-3"}>
            ...
            <Button className={"button-design tw-mr-2"}>
              Reply
            </Button>
            <Button
        ...
        <div className="comment-div">
          <span className="comment-contents">
            ...
            <p className= "guidance tw-font-bold"> User 939 barked: &quot;Awe, thats adorbes!&quot; </p>
          </span>
        </div>
      </div>
    );
