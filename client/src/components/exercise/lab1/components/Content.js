	...
	render() {
		...
		return (
			<main className="content">
				<Playthrough plays={data.plays} results={data.results} visible={data.state === EXERCISE_IDLE} />

				<AppInstructions visible={data.state !== EXERCISE_ENDED && data.state !== EXERCISE_IDLE} />
				<Repair
