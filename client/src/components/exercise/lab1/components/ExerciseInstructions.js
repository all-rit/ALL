...
class ExerciseInstructions extends Component {
	...
	render() {
		...
		switch (this.state.currentSlide) {
			...
			case 3:
				image = Image3;
				alt = 'The time is limited in the exercise, play fast to get a lot of points.';
				break;

			case 4:
				image = Image4;
				alt = 'There is a hint box in the exercise and you can click on it to get a possible hint.';
				break;
