  ...
  return (
    <div className={"tw-flex tw-flex-col tw-body-text"}>
      ...
      <p className={"tw-py-6"}>
        ...
        exercise for the Accessibility to Photosensitivity lab that was
        accepted.
      </p>
      <p>
      ...
      <DragDropGame
        ...
        colStyle={
          "tw-p-4 tw-w-48 tw-border-dashed tw-min-w-[11rem] tw-border-[#c3c3c3] tw-border-[.5px] tw-w-full tw-min-h-[10rem] tw-shadow-md tw-rounded-lg"
        }
        ...
        cardStyle={
          "tw-p-2 tw-my-1 tw-w-full tw-rounded tw-shadow-sm tw-cursor-grab tw-h-[9rem] tw-text-left tw-text-white tw-body-text tw-w-40 tw-text-black tw-bg-primary-blue"
        }
