            ...
            <Fragment>
                <div className="center-div">
                    <div className="guidance margin-bottom-2">
                        ...
                        <div>
                            <p className="playthrough__sentence">
                                In machine learning, a <b>utility equation</b> is used to assign values to certain
                                actions that the AI system can take.
                                A simplified version of a utility equation can be written
                                as:
                            </p>
                            <MathComponent tex={String.raw`Utility = \frac{Reward\;Value}{Cost\;Value}`}/>
                            <p className="playthrough__sentence">
                                The goal of a <b>utility equation</b> is to get more reward, despite the cost or higher
                                utility.
                            </p>
                        </div>
                        <p className="playthrough__sentence">
