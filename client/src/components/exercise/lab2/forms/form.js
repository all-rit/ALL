  ...
  render() {
    return (
      <div className="mainForm">
        <div>
          <p className="header1">Additional Questions</p>
          <p className="header2">
            In order to understand more about you as a user, we ask that you
            fill out this form.
          </p>
          <p className="header2">
            It will help to understand who is using the application, for what
            purpose the application is being used for, and if it is useful in
            your studies.
          </p>
          <p className="header2">
            All questions are optional, but we appreciate any information you
        ...
        <div className="formQuestions">
          ...
          <div>
            ...
            >
              ...
              <option value="CSAPX">
                AP Computer Science or Computer Science for transfers
              </option>
          ...
          <button className="formSubmit" onClick={this.onClick}>
            Submit
          </button>
        </div>
      </div>
