...
class exercise extends Component {
  ...
  render() {
    const {correctColor, incorrectColorOne, incorrectColorTwo,
      background, exerciseOption, resetOption, onChangeExerciseColors, colors,
      resetColors, selectOption, exerciseEnded, enterInfoState, enterSecondInfoState,
      exercisesPlayed, enterThirdInfoState} = this.props;
    ...
    const mainTimerRenderer = (props) => {
      if (props.total === 0) {
        ...
        return (
          <div>
            <div className='exerciseTimer'>{props.seconds}.{milliseconds}</div>
