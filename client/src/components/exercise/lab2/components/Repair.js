            ...
            <div className="code_editor__line">
              ...
              <div className="code_editor__form">
                <div className="code_editor__line">
                  ...
                  <span className="code_editor__line--darkgreen">
                    &#47;&#47; Adjust this to change the background color of the
                    page
                  </span>
                </div>
                ...
                {this.state.errorDarkBackground && (
                  <div className="code_editor__line--pink">
                    <span>&nbsp;&nbsp;</span>
                    <span className="form-error">
                      One or more of the colors you entered are too dark. Please
                      make adjustments and submit again.
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="code_editor__form">
                <div className="code_editor__line">
                  <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  <span className="code_editor__line--darkgreen">
                    &#47;&#47; Adjust this to change the color for the correct
                    option
                  </span>
                </div>
                <div className="code_editor__property code_editor__line-background--light">
              ...
              <div className="code_editor__form">
                <div className="code_editor__line">
                  <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  <span className="code_editor__line--darkgreen">
                    &#47;&#47; Adjust this to change the color for the incorrect
                    option
                  </span>
                </div>
                <div className="code_editor__property code_editor__line-background--light">
              ...
              <div className="code_editor__form">
                <div className="code_editor__line">
                  <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  <span className="code_editor__line--darkgreen">
                    &#47;&#47; Adjust this to change the color for the other
                    incorrect option
                  </span>
                </div>
                <div className="code_editor__property code_editor__line-background--light">
