  ...
  return (
    <div>
      ...
      <div className="instruction tw-flex tw-flex-row tw-w-100 tw-mx-3 tw-justify-between">
        ...
        >
          <p className="tw-body-styling-name tw-pl-6 tw-leading-snug tw-text-justify tw-w-3/4">
        ...
        >
          <p className="tw-w-1/2 tw-body-styling-name tw-leading-snug tw-text-justify ">
