...
class UserStats extends Component {
  ...
  setSecondData = (data) => {
    console.log(data)
    this.setState({totalExercisesPlayed:`${data.exercisesPlayed}`,
  ...
  render() {
    ...
    const {totalUsers, totalLogins, totalExercisesPlayed, scores, userScores} = this.state;
    ...
    const scoreTable = () => {
      let scoreTable = [];
      scoreTable.push(<tr><th colSpan='10' key='-21312312'>Exercise Scores</th></tr>);
