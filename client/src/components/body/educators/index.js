    ...
    <div className="educators-page ">
      <span className={"top-span"}>
        <div className={"left-container"}>
          ...
          <div>
            <p  className={'educator-main--body'}> Thank you for choosing Accessible Learning Labs as your partner
              in providing web accessibility and STEM education to your students.
              We are thrilled to work alongside you in fostering an inclusive
              learning environment. Our team has curated engaging
              resources and quality support to empower your teaching and inspire
              young minds. Together, let&apos;s create a brighter future where every
              student can thrive and excel in the digital world. We&apos;re honored to
              be a part of your educational journey.
            </p>
          </div>
        </div>
        <div className={'image-container'}>
          <img className={'educator-main--image'} src={educatorImage} alt={"Educator Image"} />
        </div>
      </span>
