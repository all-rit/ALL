          ...
          <ul className="module__caption">
            <li className="tw-mt-3 tw-mb-0 module__title module__lab_title">
              ...
              <ul className={"tw-text-labGreen tw-mb-3"}>
                <li>All lecture slides are available for free download</li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <div className="module__col module__lab_col">
          ...
          <ul className="module__caption">
            <li className="tw-mt-3 tw-mb-0 module__title module__lab_title">
              ...
              <ul className={"tw-text-labGreen tw-mb-3"}>
                <li>Comprehensive, step-by-step videos for each lab</li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <div className="module__col module__lab_col">
          ...
          <ul className="module__caption">
            <li className="tw-mt-3 tw-mb-0 module__title module__lab_title">
              ...
              <ul className={"tw-text-labGreen tw-mb-3"}>
                <li>Have a question or a suggestion? Let us know!</li>
              </ul>
            </li>
          </ul>
        </div>
