          ...
          <Modal isOpen={modal} toggle={toggle} className={className}>
            ...
            <ModalBody>
              <ul className="module__more_info">
                <li className="tw-body-styling-name tw-py-5">
                  {fullDescription}
                </li>
                ...
                <ul>
                  {learningObjectives.map((learningObjective) => (
                    <li
                      ...
                      className="ml-8 tw-body-styling-name list-style-disc"
                    >
                      {learningObjective}
                    </li>
                  ))}
                </ul>
                <li className="tw-body-styling-name tw-py-5">Authors:</li>
                <li className="tw-body-styling-name">{authors}</li>
              </ul>
            </ModalBody>
            <ModalFooter>
