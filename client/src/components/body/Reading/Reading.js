...
const Reading = (props) => {
  ...
  return (
    <div
      className={
        "tw-w-full tw-flex tw-flex-col tw-align-top tw-justify-center tw-h-[42rem] tw-rounded-4xl"
      }
    >
      <h2
        className={
          "tw-title-styling-name tw-text-left tw-bg-white tw-w-[100%] tw-px-10"
        }
      >
        {" "}
        Reading{" "}
