...
class Profile extends Component{
    render(){
        const { profile_image, name, title, bio ,socials,network} = this.props;
                ...
                <li id="social_media" >
                    <ul class="landingpage__row citation__social_row">
                        {socials.map((social,index)=>{
                            return <li class="citation__social_media" key={index}><SocialIcon url={social} network={network} target="__blank"/></li>
                        })}
                    </ul>
                </li>
            </ul>
