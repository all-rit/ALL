...
const DevPartners = () => {
  return (
    <div className="tw-bg-labBlue tw-py-28 tw-pl-36">
      <div className="tw-bg-labYellow tw-h-60 tw-relative tw-rounded-bl-md tw-pl-3">
        <div className="tw-bg-bgwhite tw-absolute -tw-mt-7 tw-text-left tw-px-16 tw-l tw-py-6 tw-w-full">
          ...
          <div className="tw-flex tw-flex-row tw-items-center">
            ...
            <button className="btn tw-ml-10 tw-w-36 tw-border-b-labYellow tw-border-l-labYellow tw-border-t-labBlue tw-border-r-labBlue tw-border-4">
              Learn More
            </button>
          </div>
        </div>
