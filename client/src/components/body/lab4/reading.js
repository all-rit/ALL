...
const Reading = (props) => {
    ...
    return (
      ...
      <p>
        Dexterity impairments can make it difficult to use traditional
      ...
      <p>
        The W3C organization makes several suggestions for making software
        accessible to users with dexterity impairments. One guideline is to
        ensure that all features can be accessed via a keyboard. In addition,
        another guideline is to make all touch targets (for example, a button)
        at least 9mm high by 9mm wide.
      </p>

      <h4>For more information, please visit the following websites:</h4>
      <div className="flex">
        <a
          href="https://webaim.org/articles/motor/assistive"
          target="_blank"
        ...
        <a
          href="https://www.w3.org/WAI/people-use-web/abilities-barriers/#physical"
          target="_blank"
          rel="noopener noreferrer"
        >
          W3 Physical Disabilities
        </a>
      </div>
    </div>
  );
