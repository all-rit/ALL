...
import { MILLISECONDS_IN_A_SECOND, TIMEOUT_MIN_MS, TIMER_SECONDS } from '../../../../constants/lab1';
...
class Stats extends Component {
	...
	render() {
		const { visible, score, correctAnswers, incorrectAnswers, roundNumber, time } = this.props;
