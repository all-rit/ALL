...
class FormRepair extends Component {
	...
	handleNav() {
		navigate("/Lab5/Game/FormAccessible");
	}
					...
					<div className="code_editor__content">
						...
						<div className="code_editor__code">
							...
							<span className="code_editor__line--darkgreen">
								&#47;&#47; This is where you can can add improvements to the form.
							</span>
							</div>
							<div className="code_editor__line">
							...
							<div className="code_editor__line">
								...
								<span className="code_editor__line--white">&#125;</span>
								<span className="code_editor__line--purple">&nbsp;from&nbsp;</span>
								<span className="code_editor__line--orange">'reactstrap'</span>
								<span className="code_editor__line--white">;</span>
							</div>
							...
							<div className="code_editor__line">
								...
								<span className="code_editor__line--green">FormAccessible&nbsp;</span>
							...
							<div className="code_editor__line">
								...
								<span className="code_editor__line--white">&nbsp;=&nbsp;&#123;</span>
								<span className="code_editor__line--orange">this.state.error</span>
								<span className="code_editor__line--white">&nbsp;?&nbsp;</span>
								<span className="code_editor__line--white">"</span>
								<span className="code_editor__line--orange">form-input-error</span>
								<span className="code_editor__line--white">":""&nbsp;&#125;</span>
							</div>
							<div className="code_editor__line">
								<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
							...
							<div className="code_editor__line">
								...
								<span className="code_editor__line--white">&nbsp;=&nbsp;&#123;e&nbsp;=>&nbsp;</span>
								<span className="code_editor__line--orange">this.testInputValidity</span>
								<span className="code_editor__line--white">(e)&nbsp;&#125;</span>
							</div>
							<div className="code_editor__line">
								<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
							...
							<div className="code_editor__line">
								<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								<span className="code_editor__line--white">&#123;</span>
								<span className="code_editor__line--orange">&nbsp;this.state.success&nbsp;</span>
								<span className="code_editor__line--white">&&&nbsp;</span>
							</div>
							<span className="code_editor__line--darkgreen">
								<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								&#47;&#47; Add a success message below: ie "Successful Submission"
							</span>
							<div className="code_editor__line code_editor__line-background--light">
								<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								<span className="code_editor__line--darkblue">&#60;</span>
							...
							<div className="code_editor__line">
								...
								<span className="code_editor__line--blue">onChange</span>
								<span className="code_editor__line--white">&nbsp;=&nbsp;&#123;e&nbsp;=>&nbsp;</span>
								<span className="code_editor__line--orange">this.formSubmit</span>
								<span className="code_editor__line--white">(e)&#125;&nbsp;</span>
								<span className="code_editor__line--gold">/</span>
								<span className="code_editor__line--darkblue">&#62;</span>
							...
							<div className="code_editor__line">
								...
								<span className="code_editor__line--blue">FormAccessible</span>
								<span>;</span>
							</div>
						</div>
					</div>
						...
						<div className="code_editor__code">
							...
							<div className="code_editor__form">
								<div className="code_editor__line">
									<span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
									<span className="code_editor__line--darkgreen">
									&#47;&#47; Make the border color 'red' to highlight the error input.
								</span>
								</div>
