...
class DementiaAccessible extends Component {
    ...
    render() {
        ...
        fontsize = fontsize <= maxFont && fontsize >= minFont ? fontsize: defaultFont;
        let fontfamily = state.repair5.fontfamilyvalue;
        fontfamily = fontfamily === "arial" || fontfamily === "roboto" ? fontfamily: "roboto";
        ...
        return (
                <div style={style}>
                    ...
                    <div>
                        ...
                        <div >Content made for people with dementia tends to have:
                        </div>
                        <ul>
                            <li>
                                Large, clear buttons with simple graphics and text
                            </li>
                            <li>
                                Limited features
                            </li>
