			...
			<div className="playthrough">
				...
				<div className="playthrough__content">
					<p className="playthrough__sentence">
						Your first game was probably a breeze for you if you depended on your hearing for the
					...
					<p className="playthrough__sentence">
						...
						<b>2-3 out of every 1,000 children</b> in the United States are born with a hearing loss in
