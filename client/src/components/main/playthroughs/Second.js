			...
			<div className="playthrough">
				...
				<div className="playthrough__content">
					<p className="playthrough__sentence">
						...
						However, users with hearing loss cannot hear the audio cues, which makes the game more difficult.
					</p>
					...
					<p className="playthrough__sentence">
						...
						round still apply. Click the 'Next Play' button when you’re ready to continue.
					</p>
				</div>
			</div>
		);
