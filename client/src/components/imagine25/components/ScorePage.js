  ...
  return (
    <>
      ...
      <div className="tw-grid tw-grid-cols-2 tw-pt-8 tw-justify-center">
        <div className="w-full tw-border tw-border-t-black tw-rounded-md tw-p-4 tw-m-2">
        ...
        <div className="tw-w-full tw-border tw-border-gray-300 tw-rounded-lg tw-p-4 tw-m-2">
