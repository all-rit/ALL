...
class App extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div>
                <Header count={this.state.count} handleQuiz={this.handleQuiz} handleAbout={this.handleAbout}
                        handleHome={this.handleHome} handleReading={this.handleReading} handleGame={this.handleGame}
                        handleVideo={this.handleVideo}/>

                <div>{section[this.state.count]}</div>

                <Change count={this.state.count} handleDecrement={this.handleDecrement}
                        disappearBack={this.disappearBack()} handleIncrement={this.handleIncrement}
                        disappearNext={this.disappearNext()}/>
