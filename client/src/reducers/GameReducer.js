...
export const types = {
  ...
  RESET_COUNTDOWN_TIMER:
    "@accessibility-lab/audio-cue/game/reset_countdown_timer",
  UPDATE_SCORE: "@accessibility-lab/audio-cue/game/update_score",
  INCREMENT_CORRECT_ANSWERS:
    "@accessibility-lab/audio-cue/game/increment_correct_answers",
  INCREMENT_INCORRECT_ANSWERS:
    "@accessibility-lab/audio-cue/game/increment_incorrect_answers",
  START_NEW_ROUND: "@accessibility-lab/audio-cue/game/start_new_round",
  UPDATE_HINT_BOX_STATUS:
    "@accessibility-lab/audio-cue/game/update_hint_box_status",
  ...
  UPDATE_CONGRATULATION_MESSAGE:
    "@accessibility-lab/audio-cue/game/update_congratulation_message"
};
