...
export const changeColors = (state = initialColors, action = {}) => {
  switch(action.type) {
    ...
    case UPDATE_EXERCISE_COLORS:
      return Object.assign({}, state, {exerciseBackground: action.payload[0],
        exerciseRightCircle: action.payload[1], exerciseWrongCircleOne: action.payload[2],
...
export const changeExerciseState = (state = initialExerciseState, action = {}) => {
  switch(action.type) {
    case START_EXERCISE:
    ...
    case STAT_STATE:
      return {...state, statState: true, aboutState: false, exerciseState: false}
    case END_STAT_STATE:
      return {...state, statState: false}
    case INFO_STATE:
      return {...state, secondInfoState: true, exerciseState: false,
        exercisesPlayed: initialExerciseState.exercisesPlayed = 1}
    case END_INFO_STATE:
      return {...state, secondInfoState: false}
    case INFO_STATE_TWO:
      return {...state, thirdInfoState: true, exerciseState: false,
    ...
    case INFO_STATE_THREE:
      return {...state, fourthInfoState: true, exerciseState: false,
