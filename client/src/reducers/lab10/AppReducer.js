export const types = {
  UPDATE_POPUP: "@accessibility-lab/lab10/app/update_popup",
  OPEN_INSTRUCTIONS: "@accessibility-lab/lab10/app/open_instructions",
  CLOSE_INSTRUCTIONS: "@accessibility-lab/lab10/app/close_instructions",
};
